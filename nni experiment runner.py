...
print(os.path.join(DATA_DIR, TRAIN_FILE_NAME))
script_params = " ".join([
    "--datastore", DATA_DIR,
...
hyper_params = {
    ...
    'hidden_size': { "_type": "choice", "_value": [30,60,40] },
    'batch_size' : { "_type": "choice", "_value": [50, 32,64] }
}
...
config = {
    "authorName": "AmirReza",
    "experimentName": "GRU4Rec Optimization NNI",
    "trialConcurrency": 3,
    "maxExecDuration": "72h",
    "maxTrialNum": 8,
    ...
    ## there is a problem with path specified for python so i removed it because i have added python to my sys env in windows
    ## sys.prefix + "/bin/
    "trial":  {
